        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              <button className="bg-yellow-500 text-emerald-950 px-8 py-3 rounded-lg font-semibold hover:bg-yellow-400 transition-colors">
                Teller Login
              </button>
              <button className="border-2 border-yellow-500 text-yellow-500 px-8 py-3 rounded-lg font-semibold hover:bg-yellow-500/10 transition-colors">
                System Guide
              </button>
            </div>
          </div>
